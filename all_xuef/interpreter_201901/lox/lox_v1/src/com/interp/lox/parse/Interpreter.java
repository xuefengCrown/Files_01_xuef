...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
	...
	void evalBlock(List<Stmt> statements, Environment newEnv) {
		/**
		 * this.environment 是我们的interpreter的唯一环境 reference 所有的求值都是在此 reference
		 * 所指向的 environment下进行。 我们这里通过修改 this.environment来改变求值环境。
		 * 所以，求值结束后，一定要恢复到原来的环境!!!
		 */
	...
	public Void visitFunctionStmt(Function stmt) {
		// We take a function syntax node—a compile time representation of
		// the function—and convert it to its runtime representation.
