 ...
 *  drawing鈥攎ethods that draw geometric shapes and methods that
 ...
 *  call a drawing
 *  method鈥攕uch as {@code point()} or {@code line()}鈥攖he
 ...
 *       the canvas is permitted鈥攈owever, only the part of the object that
