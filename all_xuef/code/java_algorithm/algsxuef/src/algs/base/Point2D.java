...
public final class Point2D implements Comparable<Point2D> {
     ...
     * @return the angle (in radians) of this point in polar coordiantes (between 鈥�&pi;/2 and &pi;/2)
     */
    public double theta() {
     ...
     * @return the angle in radians (between 鈥�&pi; and &pi;) between this point and that point (0 if equal)
     */
    ...
    /**
     * Returns true if a鈫抌鈫抍 is a counterclockwise turn.
     * @param a first point
     * @param b second point
     * @param c third point
     * @return { -1, 0, +1 } if a鈫抌鈫抍 is a { clockwise, collinear; counterclocwise } turn.
     */
    ...
    /**
     * Compares two points by atan2() angle (between 鈥�&pi; and &pi;) with respect to this point.
     *
     * @return the comparator
     */
