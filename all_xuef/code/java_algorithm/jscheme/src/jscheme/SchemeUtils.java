...
public abstract class SchemeUtils {
	...
	// ////////////// Conversion Routines ////////////////
	/* 将潜在的 scheme 对象 映射为 java 中的对应 类型 */
	...
	/**
	 * Coerces a Scheme object to a Scheme input port, which is an InputPort. If
	 * the argument is null, returns interpreter.input.
	 **/
	...
	/**
	 * A continuable error. Prints an error message and then prompts for a value
	 * to eval and return.
	 **/
	...
	public static boolean eqv(Object x, Object y) {
		return x == y || (x instanceof Double && x.equals(y))
	 ...
	 * (not a Scheme string). If quoted is true, use "str" and #\c, otherwise
	 * use str and c. You need to pass in a StringBuffer that is used to
	 * accumulate the results. (If the interface didn't work that way, the
	 * system would use lots of little internal StringBuffers. But note that you
	 * can still call <tt>stringify(x)</tt> and a new StringBuffer will be
	 * created for you.
	 **/
	...
	/**
	 * Convert x to a Java String giving its external representation. Strings
	 * and characters are quoted.
	 **/
	...
	/**
	 * Convert x to a Java String giving its external representation. Strings
	 * and characters are quoted iff <tt>quoted</tt> is true..
	 **/
