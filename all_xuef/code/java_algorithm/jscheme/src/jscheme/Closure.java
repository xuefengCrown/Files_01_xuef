...
/**
 * A closure is a user-defined procedure. It is "closed" over the environment in
 * which it was created. To apply the procedure, bind the parameters to the
 * passed in variables, and evaluate the body.
 * 
...
public class Closure extends Procedure {
	...
	public Closure(Object parms, Object body, Environment env) {
		this.parms = parms;
		this.env = env;
		this.body = (body instanceof Pair && rest(body) == null) ? first(body)
				: cons("begin", body);
	}
