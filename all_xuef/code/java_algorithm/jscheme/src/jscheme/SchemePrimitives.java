...
/**
 * Holds a string representation of some Scheme code in <TT>CODE</tt>. A string
 * is better than a file because with no files, its easier to compress
 * everything in the classes.jar file. For editing convenience, the following
 * two perl convert from normal text to this Java quoted format and back again:
 * 
 * <pre>
...
public class SchemePrimitives {
	...
	public static final String CODE = "(define call/cc    call-with-current-continuation)\n"
			+ "(define first 	   car)\n"
			+ "(define second     cadr)\n"
			+ "(define third      caddr)\n"
			+ "(define rest 	   cdr)\n"
