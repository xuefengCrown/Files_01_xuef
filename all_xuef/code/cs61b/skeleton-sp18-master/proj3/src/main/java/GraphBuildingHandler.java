...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    // keep track of all the nodes of one way
    private List<Long> nodesOfWay = new ArrayList<>();
    /**
...
//            System.out.println("Finishing a way...");
            if(wayValid){
                for(int i = 0; i < nodesOfWay.size()-1; i++){
                    Long v1 = nodesOfWay.get(i);
                    Long v2 = nodesOfWay.get(i+1);
                    g.addEdge(v1, v2);
                    g.addEdge(v2, v1);
                }
            }
