; (load "C:/code_dxf/xuefgit/Files_01_xuef/all_xuef/code/Practical_CL/01_mp3_db.lisp")
...
;;; test
;; (add-record (make-cd "Roses" "Kathy Mattea" 7 t))  (add-record (make-cd "Fly" "Dixie Chicks" 8 t))  (add-record (make-cd "Home" "Dixie Chicks" 9 t))
